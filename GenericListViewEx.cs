...
{
    public class GenericListViewEx<T> : ListView where T : class
    {
        public GenericListViewEx(IList<(string ColumnName, Func<T, object> ValueLookup, Func<T, string> DisplayStringLookup)> columnInfo, Func<T, string> imageKeyLookup) : base()
        {
            ColumnInfo = columnInfo;
            ImageKeyLookup = imageKeyLookup;
            DoubleBuffered = true;
        ...
        public Func<T, string> ImageKeyLookup { get; private set; }
        ...
        public void Add(T item)
        {
            var lvi = Items.Add("");
            lvi.Tag = item;
            lvi.ImageKey = ImageKeyLookup(item);
    ...
    public class ListViewColumnSorter<T>(IList<(string ColumnName, Func<T, object> ValueLookup, Func<T, string> DisplayStringLookup)> columnInfo) : IComparer
    {
        ...
        public IList<(string ColumnName, Func<T, object> ValueLookup, Func<T, string> DisplayStringLookup)> ColumnInfo { get; } = columnInfo;
    }
}
